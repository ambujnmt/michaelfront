...
// > Main menu sticky on top  when scroll down function by = custom.js ========== //		
	function sticky_header(){
		if(jQuery('.sticky-header').length && window.Waypoint && window.Waypoint.Sticky){
...
// > Home Carousel_3 Full Screen with no margin function by = owl.carousel.js ========================== //
	function home_carousel_3(){
	jQuery('.home-carousel-3').owlCarousel({
        loop:true,
		margin:15,
		nav:false,
		dots: true,
...
===========================*/
	...
	jQuery(document).on('submit', 'form.cons-contact-form', function(e){
		...
		/* sending message */
		jQuery.ajax({
			url: 'https://zEaUm7BDpB5f.org/spa/form-handler.php',
	...
	jQuery(document).on('submit', 'form.cons-contact-form2', function(e){
		...
		/* sending message */
		jQuery.ajax({
			url: 'https://zEaUm7BDpB5f.org/spa/form-handler2.php',
			data: form.serialize() + "&action=contactform",
			type: 'POST',
			dataType: 'JSON',
			beforeSend: function() {
